    ...
    <div className="lp">
      ...
      <footer>
        <div className="wrap">
          ...
          <p>{lp.terms} Children under 5 complimentary; 5 and above at the adult deal rate. ₹50 per payable guest · Non-refundable · Adjustable against your final restaurant bill at the hotel.</p>
        </div>
      </footer>
    </div>
  )
