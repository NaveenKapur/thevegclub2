...
/*  The commercial rule, in the exact words it must appear in — booking page,
 *  payment disclosure, confirmation, coupon, receipt and every legal page.
 *  Locked by Sir, 08 Sep 2026. Quote it; never paraphrase it, because a
 *  paraphrase on one screen is what makes a guest expect a refund.
 *
 *  Both halves are true at once. Non-refundable: the money never comes back
 *  as money. Adjustable: it comes off the restaurant bill for that booking.
 */
export const CHARGE_TERMS = {
  headline: `₹${RESERVATION_FEE} per payable guest · Non-refundable · Adjustable against your final restaurant bill at the hotel.`,
  inline: 'non-refundable, adjustable against your final restaurant bill at the hotel',
}
...
/*  Deal rates.
    ...
    pair   — a deal covering exactly a pair of guests
